                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php
$stmt = $connect->prepare("SELECT title,content,id ,created_at FROM posts");
$stmt->execute();
...
<tbody>
  <tr>
    ...
    <td><a href='./editpost.php?id=<?php echo $row["id"]; ?>'><img src="./images/edit.png" alt="Edit"></a>
    <td><a href='./delete.php?id=<?php echo $row["id"]; ?>'><img src="./images/delete.png" alt="Delete"></a></td>
  </tr>
</tbody>
<?php
}
